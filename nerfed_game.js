    ...
    this.drawMoveControls = function(dragon)
    {
        ...
        if(this.moveControlsCords.mode === "main"){
            ...
            if(this.dragon.energy > 0 && this.dragon.powerIsActive === false)
                dragon.powers.attack[dragon.powers.attack.length - 1].use(this.dragon);
            this.activeButton = null;
            ...
            this.drawButtons();*/
            if(this.dragon.energy > 0 && this.dragon.powerIsActive === false)
                dragon.powers.defense[dragon.powers.defense.length - 1].use(this.dragon);
            this.activeButton = null;
            ...
            this.drawButtons();*/
            if(this.dragon.energy > 0 && this.dragon.powerIsActive === false)
                dragon.powers.heal[dragon.powers.heal.length - 1].use(this.dragon);
            this.activeButton = null;
            ...
            this.drawButtons();*/
            if(this.dragon.energy > 0 && this.dragon.powerIsActive === false)
                dragon.powers.walk[dragon.powers.walk.length - 1].use(this.dragon);
            this.activeButton = null;
            ...
            this.drawButtons();*/
            if(this.dragon.energy > 0 && this.dragon.powerIsActive === false)
                dragon.powers.other[dragon.powers.other.length - 1].use(this.dragon);
            this.activeButton = null;
        ...
        if(this.dragon.powerIsActive === false)
            this.changeMode("main");
